...
/**
 * Client for the Lottery Numbers API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://lottery.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/lottery';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LotteryClient] {$message}\n";
        }
    }
}
