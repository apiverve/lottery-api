...
```gradle
dependencies {
    implementation 'com.github.apiverve:lottery-api:1.1.14'
}
```
...
```java
import com.apiverve.lottery.LotteryNumbersAPIClient;
import com.apiverve.lottery.APIResponse;
import com.apiverve.lottery.APIException;

// Initialize the client
LotteryNumbersAPIClient client = new LotteryNumbersAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("numbers", "powerball");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/lottery](https://docs.apiverve.com/ref/lottery)
...
- **Documentation:** [https://docs.apiverve.com/ref/lottery](https://docs.apiverve.com/ref/lottery)
- **Issues:** [GitHub Issues](https://github.com/apiverve/lottery-api/issues)
