    ...
    class LotteryNumbersExample
    {
        ...
        static async Task<JsonDocument> CallLotteryNumbersAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;numbers&quot;] &#x3D; &quot;megamillions&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Lottery Numbers API...\n");

            var result = await CallLotteryNumbersAPI();
