# Lottery Numbers API - Examples

This folder contains example code for using the Lottery Numbers API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/lottery',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/lottery");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/lottery](https://docs.apiverve.com/ref/lottery)
