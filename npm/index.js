...
class lotteryWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/lottery');
        }
        ...
        this.validationRules = {"numbers":{"type":"string","required":true},"date":{"type":"string","required":false,"format":"date"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/lottery`);
        }
    }
