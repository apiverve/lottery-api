...
namespace APIVerve.API.LotteryNumbers
{
    ...
    /// <summary>
    /// Client for the LotteryNumbers API
    /// </summary>
...
#endif
    {
        ...
        {
            { "numbers", new ValidationRule { Type = "string", Required = true } },
        ...
        public LotteryNumbersAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LotteryNumbersAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LotteryNumbersAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(LotteryNumbersQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(LotteryNumbersQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(LotteryNumbersQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(LotteryNumbersQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(LotteryNumbersQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(LotteryNumbersQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
