...
// Request contains the parameters for the Lottery Numbers API.
//
// Parameters:
...
type Request struct {
	Numbers string `json:"numbers"` // Required
...
// ResponseData contains the data returned by the Lottery Numbers API.
