// Package lottery provides a Go client for the Lottery Numbers API.
//
// For more information, visit: https://apiverve.com/marketplace/lottery?utm_source=go&utm_medium=readme
package lottery
...
const (
	baseURL        = "https://api.apiverve.com/v1/lottery"
	defaultTimeout = 30 * time.Second
)

// Client is the Lottery Numbers API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Lottery Numbers API client.
...
// Execute makes a request to the Lottery Numbers API with typed parameters.
//
...
//   - numbers (required): string - The lottery game to lookup
//   - date: string - Optional date for historical lookup (YYYY-MM-DD). Returns the nearest draw to this date. [format: date]
